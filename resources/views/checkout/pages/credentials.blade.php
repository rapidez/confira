            ...
            <x-rapidez-ct::layout.checkout>
                ...
                >
                    ...
                    <x-rapidez-ct::toolbar class="*:flex-1 max-sm:flex-col-reverse">
                        ...
                        <x-rapidez::button.conversion data-testid="continue" loader v-on:mousedown.prevent="{{-- Do not remove, this prevents requiring double click for the submit action --}}">
                            @lang('Next')
