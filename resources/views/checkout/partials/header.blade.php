<div class="flex flex-wrap gap-y-3 lg:mr-20">
    <x-rapidez-ct::button.outline v-if="checkout.step == 2" class="flex items-center justify-center !p-0 w-[50px] h-[50px] md:hidden" :href="route('cart')">
        <x-heroicon-o-arrow-long-left class="w-6 h-6"/>
    </x-rapidez-ct::button.outline>
    <x-rapidez-ct::button.outline v-else class="flex items-center justify-center !p-0 w-[50px] h-[50px] md:hidden" v-on:click.prevent="goToStep(1)">
        <x-heroicon-o-arrow-long-left class="w-6 h-6"/>
    </x-rapidez-ct::button.outline>
